...
@section('content')
    ...
    {!! Form::model($user, ['route' => ['{city}.users.update', $user->id, Request::route()->getParameter('city')], 'method' => 'put', 'class' => 'form']) !!}
    ...
    @role('admin')
		<div class="form no-mgt">
			<div class="form-row">
			    <div class="form-row-body">
			        {!! delete_form(['{city}.users.destroy', Request::route()->getParameter('city'), $user->id ]) !!}
			    </div>
			</div>
		</div>
	@endrole
