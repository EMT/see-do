...
return array(
    ...
    */
    ...
    |
    */
    'default_format'                        => '<div class="left-align-wrapper offset-wrapper"><div class="alert alert-:type">:message</div></div>',
    ...
    */
    'default_formats'                       => array(
        'info'                  => '<div class="left-align-wrapper offset-wrapper"><div class="alert alert-info">:message</div></div>',
        'success'               => '<div class="left-align-wrapper offset-wrapper"><div class="alert alert-success">:message</div></div>',
        'warning'               => '<div class="left-align-wrapper offset-wrapper"><div class="alert alert-warning">:message</div></div>',
        'error'                 => '<div class="left-align-wrapper offset-wrapper"><div class="alert alert-danger">:message</div></div>',
    ),
